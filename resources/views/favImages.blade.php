...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('fluid-gallery.css')}}">
    <link href="{{URL::asset('vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="{{URL::asset('/js/favImages.js')}}"></script>
            ...
            <div class="container" id="navbarResponsive">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ url('/home') }}"><h3> Home </h3></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#"><h3> About </h3></a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ url('/favImages') }}"><h3> Favourite Images </h3></a>
